...
import com.ljb.imageviewer.udarawanasinghe.extensions.ViewConfigurationCompatExtended
import com.ljb.imageviewer.udarawanasinghe.extensions.focusPoint
...
class TransformGestureDetector : Transformable {
    ...
    /**
     * [TransformGestureDetector] instance 를 만들기 전에
     * [ViewConfigurationCompatExtended.setTouchSlop]를 호출하여 touch slop 값을 업데이트합니다.
     */
    ...
    fun onTouchEvent(event: MotionEvent): Boolean {
        when (event.actionMasked) {
            MotionEvent.ACTION_DOWN -> {
                ...
                Log.e("Touch", "${this.javaClass.name} onTouchEvent : ACTION_DOWN")
            }
            ...
            MotionEvent.ACTION_POINTER_DOWN -> {
                ...
                event.savePointers()
                Log.e("Touch", "${this.javaClass.name} onTouchEvent : ACTION_POINTER_DOWN")
            }
            ...
            MotionEvent.ACTION_MOVE -> {
                ...
                Log.e("Touch", "${this.javaClass.name} onTouchEvent : ACTION_MOVE")
            }
            ...
            MotionEvent.ACTION_POINTER_UP -> {
                ...
                Log.e("Touch", "${this.javaClass.name} onTouchEvent : ACTION_POINTER_UP")
            }
            ...
            MotionEvent.ACTION_UP -> {
                ...
                if (detectSingleTap) {
                    ...
                    Log.e("Touch", "${this.javaClass.name} onTouchEvent : ACTION_UP - detectSingleTap")
                }
                if (detectLongPress) {
                    val dt = event.eventTime - event.downTime
                    ...
                    Log.e("Touch", "${this.javaClass.name} onTouchEvent : ACTION_UP - detectLongPress")
                }
                // do fling animation
                if (isFlingEnabled) {
